...
# Build the image
DOCKER_DEFAULT_PLATFORM="linux/amd64"  docker build -t daqiancode/mini-oauth2:0.0.8 .
docker push daqiancode/mini-oauth2:0.0.8
# Run the container
docker run -p 3000:3000 --rm --env-file .env daqiancode/mini-oauth2:0.0.8
